...
const ensureDepartmentHierarchy = async ({
  ...
  if (
    ...
    // Intentionally keep legacy folders in place for audit-safe normalization.
    // Duplicate cleanup is handled by explicit reconciliation review flows, not automatic deletion.
  }
